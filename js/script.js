...
fetch('https://js2-tareas-api.netlify.app/api/tareas?uid=27')
...
fetch('https://js2-tareas-api.netlify.app/api/tareas?uid=27',fetchOptions)
.then((response)=> response.json())
.then((data)=>{
  console.log(data)
...
function taskStatus(id, complete) {
  ...
  fetch('https://js2-tareas-api.netlify.app/api/tareas?uid=27',Annadir)
  .then((response)=>response.json())
  .then((data)=>{
    console.log(data)
    taskStatus(data);
...
function deleteTask(id) {
  ...
  fetch('https://js2-tareas-api.netlify.app/api/tareas?uid=27',Borrar)
  .then((response)=>response.json())
  .then((data)=>{
    console.log(data)
    deleteTask(data);
